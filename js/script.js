...
const app = new Vue({
  ...
  data: {
    planningGiornata: [
      ...
      {
        text: "Incontrare Fili",
        done: true,
      },
      {
        text: "Pulire bicicletta",
        done: false,
      },
      {
        text: "Comprare lampadina",
        done: false,
      },
      {
        text: "Tagliare siepe",
    ...
    ////// deve essere collegata con il v-model?
    nuovaAttivita: "",
  },
  methods: {
    ...
    aggiungiAttivita() {
      ...
      if (attivitaDaAggiungere.length > 0) {
        let nuovoOggetto = {
          text: attivitaDaAggiungere,
          done: false,
        };
        this.planningGiornata.push(nuovoOggetto);
